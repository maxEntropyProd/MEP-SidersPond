!jjv 21-Nov-2017 The original file provided for bacoli incorrectly
!jjv calculated dmach(3) and dmach(4).  They were 2 times too large.   
...
! ..
      ...
      CASE (2)
        d1mach = huge(zero)
      CASE (3)
!jjv    d1mach = epsilon(zero)
        d1mach = epsilon(zero)/base
      CASE (4)
!jjv    d1mach = base*epsilon(zero)
        d1mach = epsilon(zero)
      CASE (5)
        d1mach = log10(base)
      END SELECT
