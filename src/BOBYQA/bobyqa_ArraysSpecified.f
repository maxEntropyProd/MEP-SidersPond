...
C
  ...
  200 RETURN
     ...
     1  XPT,FVAL,GOPT,HQ,PQ,BMAT,ZMAT,NDIM,SL,SU,NF,KOPT)
      IMPLICIT REAL*8 (A-H,O-Z)
c      DIMENSION X(*),XL(*),XU(*),XBASE(*),XPT(NPT,*),FVAL(*),GOPT(*),
c     1  HQ(*),PQ(*),BMAT(NDIM,*),ZMAT(NPT,*),SL(*),SU(*)
      DIMENSION X(n),XL(n),XU(n),XBASE(*),XPT(NPT,*),FVAL(*),GOPT(*),
...
C
     ...
     2  KOPT,VLAG,PTSAUX,PTSID,W)
      IMPLICIT REAL*8 (A-H,O-Z)
c      DIMENSION XL(*),XU(*),XBASE(*),XPT(NPT,*),FVAL(*),XOPT(*),
c     1  GOPT(*),HQ(*),PQ(*),BMAT(NDIM,*),ZMAT(NPT,*),SL(*),SU(*),
c     2  VLAG(*),PTSAUX(2,*),PTSID(*),W(*)
      DIMENSION XL(n),XU(n),XBASE(*),XPT(NPT,*),FVAL(*),XOPT(*),
